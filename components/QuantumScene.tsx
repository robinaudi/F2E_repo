...
import { Float, Sphere, Stars, Environment, Points, PointMaterial } from '@react-three/drei';
    ...
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 5], fov: 45 }}>
        ...
        <Float speed={2} rotationIntensity={0.5} floatIntensity={0.5}>
            ...
            {/* Lines between nodes would be complex in pure JSX, keeping it simple with dots representing nodes */}
